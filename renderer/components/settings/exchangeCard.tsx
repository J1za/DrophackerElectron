      ...
      <div className="flex flex-inline gap-4 items-end justify-between mt-4">
        <div className="flex flex-1">
          <InputTextDropDown
            ...
            setValue={
              setExchange.setKey("credentials").setKey("apiKey").setValue
            }
            width="100%"
          />
        </div>
        <div className="flex flex-1">
          <InputTextDropDown
            ...
            setValue={
              setExchange.setKey("credentials").setKey("secretKey").setValue
            }
            width="100%"
          />
        </div>
        <div className="flex flex-1">
          <InputTextDropDown
            ...
            setValue={
              setExchange.setKey("credentials").setKey("passphrase").setValue
            }
            width="100%"
          />
        </div>
