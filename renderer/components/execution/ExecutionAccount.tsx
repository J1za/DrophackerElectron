...
export function ExecutionAccount({
  ...
  return (
    <div className="justify-center step">
      <div className="flex flex-col ">
        ...
        <div
          className="flex flex-wrap items-center justify-between flex-inline"
          style={{ flex: 1 }}
        >
          <div className="flex gap-4 flex-inline">
            <Link
          ...
          <div className="flex flex-wrap gap-2 flex-inline">
            <BtnStatusColor
              text={
                <span className="flex gap-1 flex-inline">
